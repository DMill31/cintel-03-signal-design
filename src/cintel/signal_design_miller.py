"""
signal_design_miller.py - Project script .
...
Paths (relative to repo root)
    ...
    OUTPUT FILE: artifacts/signals_miller.csv

Terminal command to run this file from the root project folder

    uv run python -m cintel.signal_design_miller
...
OUTPUT_FILE: Final[Path] = ARTIFACTS_DIR / "signals_miller.csv"
